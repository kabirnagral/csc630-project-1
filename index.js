...
app.post("/address/create", function(req, res){
  geocoder.geocode(req.body.address, function(err, result) {
    client.query(`INSERT INTO Addresses (AddressTitle,Address,Lat,Long,UserID) VALUES ('${req.body.addressTitle}','${req.body.address}',${result[0].latitude},${result[0].longitude},${req.body.userID});`, function(err, result){
