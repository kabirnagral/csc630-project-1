...
pool.query('CREATE TABLE IF NOT EXISTS Users (UserID int GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, DisplayName varchar(255), UserName varchar(255), Lat float(5), Long float(5))', function(err, res){ //Users Table
  if(!err) console.log("Successfully created Users table");
});

pool.query('CREATE TABLE IF NOT EXISTS Addresses (AddressID int GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, AddressTitle varchar(255),Address varchar(255), Lat float(5), Long float(5), UserID int)', function(err, res){ //Addresses Table
